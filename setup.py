...
setup(name='pyenvisalink',
      ...
      download_url='https://github.com/Cinntax/pyenvisalink/tarball/4.5',
      author='Dan Cinnamon',
      author_email='dcinnamon@gmail.com',
      license='MIT',
      packages=['pyenvisalink'],
      classifiers=['Development Status :: 4 - Beta', 'Programming Language :: Python :: 3.5', 'Programming Language :: Python :: 3.6', 'Programming Language :: Python :: 3.7']
      )
